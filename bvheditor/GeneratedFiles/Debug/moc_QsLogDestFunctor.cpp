...
#include "../../QsLog2/QsLogDestFunctor.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QsLogging__FunctorDestination_t, stringdata) + ofs \
...
const QMetaObject QsLogging::FunctorDestination::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QsLogging__FunctorDestination.data,
      qt_meta_data_QsLogging__FunctorDestination,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsLogging__FunctorDestination.stringdata))
